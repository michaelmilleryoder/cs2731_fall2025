...
**Due 2025-09-24, 11:59pm**. *Instructions last updated 2025-09-10.*
...
* [Test data](hw3/test_data.zip) of *New York Times* articles and several of Shakespeare's sonnets. Note that this text data is encoded in `Latin1` instead of `utf8`.
...
2. Report some of your generated text for trigrams, 4-grams and 7-grams and discuss. What do you notice about the short passages you've generated from n-gram models with different *n*? Are they as good as [1000 monkeys working at 1000 typewriters](https://www.youtube.com/watch?v=no_elVGGgW8)? Are there patterns in what models generate first?
...
* Your report with results and answers to questions, named `report_{your pitt email id}_hw3.pdf`. No need to include @pitt.edu, just use the email ID before that part. For example: `report_mmyoder_hw3.pdf`.
